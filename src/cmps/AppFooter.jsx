...
import { useYoutubePlayer } from '../customHooks/useYoutubePlayer.js'
...
export function AppFooter() {
    ...
    const onNextTrack = useCallback(async () => {
        ...
        try {
            ...
            const adaptedTrack = {
                ...trackService.adaptTrackForPlayer(nextTrack),
                videoId,
            }
    ...
    const onPrevTrack = useCallback(async () => {
        ...
        try {
            ...
            const adaptedTrack = {
                ...trackService.adaptTrackForPlayer(prevTrack),
                videoId,
            }
    ...
    const randomSpotifyTrack = useMemo(() => {
        ...
        const station =
            stationsWithTracks[
                Math.floor(Math.random() * stationsWithTracks.length)
            ]
    ...
    return (
        <footer className='player-footer'>
            ...
            <div className='player-footer-right'>
             ...
             <button className='btn-volume' onClick={toggleVolume}>
                {volume ? 
            ...
            <section className='mobile-nav-bar'>
                <NavLink
                    to='/'
                    className='mobile-home-link flex column align-center justify-center'
                >
                    <HomeIcon />
                    <span>Home</span>
                </NavLink>
                <NavLink
                    to='/search'
                    className='mobile-search-link flex column align-center justify-center'
                >
                    <SearchIcon /> <span>Search</span>
                </NavLink>
                <NavLink
                    to='/liked'
                    className='mobile-library-link flex column align-center justify-center'
                >

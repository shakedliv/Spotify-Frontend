    ...
    return (
        <footer className='player-footer'>
            ...
            <section className='mobile-nav-bar'>
                <NavLink to='/' className='mobile-home-link flex column align-center justify-center'>
                    <HomeIcon />
                    <span>Home</span>
                </NavLink>
                <NavLink to='/search' className='mobile-search-link flex column align-center justify-center'>
                    <SearchIcon /> <span>Search</span>
                </NavLink>
                <NavLink to='/liked' className='mobile-library-link flex column align-center justify-center'>

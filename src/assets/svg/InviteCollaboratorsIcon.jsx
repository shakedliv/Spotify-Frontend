export function InviteCollaboratorsIcon({ className = "" }) {
    return (
        <svg
            viewBox="0 0 16 16"
            className={`invite-collaborators-icon ${className}`}
            data-encore-id="icon"
            role="img"
            aria-hidden="true"
            fill="currentColor"
